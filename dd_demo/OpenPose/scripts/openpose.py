...
net = cv.dnn.readNetFromTensorflow("/home/robot/catkin_ws/src/dd_demo/OpenPose/scripts/graph_opt.pb")
...
while cv.waitKey(1) < 0:
    ...
    path = '/home/robot/photos/887.jpg'
    #print('while' + path)
    ...
    if points[1] is not None:
        if points[1][1] > frameHeight / 2:
            print('detected the falling down\n')
            pub.publish('fall down')
            path = '/home/robot/photos/falldown.jpg'
